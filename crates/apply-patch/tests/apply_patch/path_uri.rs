...
use codex_apply_patch::absolute_path::normalize_windows_device_path;
use codex_apply_patch::path_uri::*;
        ...
        assert_eq!(
            ...
            Some(
                LegacyAppPathString::from_string(path)
                    ...
                    .expect("opaque Windows path should convert"),
            ),
            "parsing {path}"
        );
        let expected = PathUri::from_absolute_native_path(path, PathConvention::Windows)
