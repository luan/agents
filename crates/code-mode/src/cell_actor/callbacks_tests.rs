...
// The probe panics on purpose, and unwinding out of a worker thread in this v8-linked test
// binary aborts with "failed to initiate panic, error 5". Predates the workspace move.
