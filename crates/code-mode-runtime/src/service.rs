...
use code_mode_protocol::CellId;
use code_mode_protocol::CodeModeNestedToolCall;
use code_mode_protocol::CodeModeSession;
use code_mode_protocol::CodeModeSessionDelegate;
use code_mode_protocol::CodeModeSessionProvider;
use code_mode_protocol::CodeModeSessionProviderFuture;
use code_mode_protocol::CodeModeSessionResultFuture;
use code_mode_protocol::CodeModeToolKind;
use code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use code_mode_protocol::ExecuteRequest;
use code_mode_protocol::ExecuteToPendingOutcome;
use code_mode_protocol::FunctionCallOutputContentItem;
use code_mode_protocol::ImageDetail;
use code_mode_protocol::NotificationFuture;
use code_mode_protocol::RuntimeResponse;
use code_mode_protocol::StartedCell;
use code_mode_protocol::ToolInvocationFuture;
use code_mode_protocol::WaitOutcome;
use code_mode_protocol::WaitRequest;
use code_mode_protocol::WaitToPendingOutcome;
use code_mode_protocol::WaitToPendingRequest;
...
pub fn yield_timeout(yield_time_ms: u64) -> Duration {
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: code_mode_protocol::ToolName {
