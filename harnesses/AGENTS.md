...
3. Stop at the first rung that works: remove the need, reuse project code, use the standard library, use the platform, use an installed dependency, write one line, or write the minimum implementation.
...
9. Typesafety is useful. Take advantage of it.
