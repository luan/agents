...
function getCharType(ch: string | undefined, semanticClass: WordMotionClass = "word"): CharType {
...
function buildWordBoundaryData(line: string, semanticClass: WordMotionClass = "word"): WordBoundaryData {
...
export class WordBoundaryCache {
	...
	constructor(maxEntries: number = DEFAULT_MAX_CACHE_ENTRIES) {
		this.maxEntries = Number.isInteger(maxEntries) && maxEntries > 0 ? maxEntries : DEFAULT_MAX_CACHE_ENTRIES;
	}
