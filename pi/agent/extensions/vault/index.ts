...
function renderVaultCall(
  ...
  return renderText(
    ctx,
    title(theme, vaultIcon(operation), `vault ${operation}`, detail ?? ""),
  );
}

function renderVaultResult(
  operation: string,
  result: any,
  theme: any,
  ctx: any,
  ...
  return renderText(
    ...
    line(theme, [
      chip(
        ...
        vaultIcon(operation),
        operation,
        summarizeVaultOutput(raw || stderr),
      ),
    ]),
  );
}
...
export default function vaultExtension(pi: ExtensionAPI) {
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("create", `${args.kind} · ${args.topic}`, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("create", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("list", args.kind ?? "all", theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("list", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("read", args.target, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("read", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall(
        "archive",
        args.target ?? `${args.targets?.length ?? 0} targets`,
        theme,
        ctx,
      ),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("archive", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall(
        "prune",
        `${args.kind ?? "all"} · ${args.days ?? "default"}d`,
        theme,
        ctx,
      ),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("prune", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("comments", args.target, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("comments", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("rename", `${args.old} → ${args.newSlug}`, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("rename", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("retag", args.target, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("retag", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("related", args.topic, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("related", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (_args, theme, ctx) =>
      renderVaultCall("check", undefined, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("check", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("search", args.query, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("search", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (_args, theme, ctx) =>
      renderVaultCall("status", undefined, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("status", result, theme, ctx),
  });
  ...
  registerTool({
    ...
    renderCall: (args, theme, ctx) =>
      renderVaultCall("commit", args.path, theme, ctx),
    renderResult: (result, _options, theme, ctx) =>
      renderVaultResult("commit", result, theme, ctx),
  });
}
