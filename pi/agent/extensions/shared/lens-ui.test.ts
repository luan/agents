...
describe("Lens Pi UI rendering", () => {
	...
	it("renders compact clean, warning, degraded/error, and patch states", () => {
		...
		expect(renderLensCompactStatus(pending)).toContain("queue: cargo fmt --check");
		expect(renderLensCompactStatus(pending)).toContain("suggested: cargo clippy -- -D warnings");
