...
describe("mosaic orchestration tool filtering", () => {
	test("blocks recursive mosaic orchestration tools inside subagents", () => {
		...
		expect(isMosaicOrchestrationToolName("task")).toBe(true);
		expect(isMosaicOrchestrationToolName("subagent_list")).toBe(true);
		expect(isMosaicOrchestrationToolName("subagent_send")).toBe(true);
		expect(isMosaicOrchestrationToolName("ask_user")).toBe(true);
		expect(isMosaicOrchestrationToolName("task_write")).toBe(true);
