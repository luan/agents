...
function detectTmuxImageProtocol(): NativeImageProtocol | null {
	...
	if (process.env.WEZTERM_EXECUTABLE || process.env.WEZTERM_CONFIG_DIR || process.env.WEZTERM_CONFIG_FILE) return "kitty";

	const termProgram = process.env.TERM_PROGRAM ?? "";
	const term = termProgram && termProgram !== "tmux" && termProgram !== "screen"
