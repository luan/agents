---
name: triage
description: Triage vault specs/tasks with category and stage tags; prepare work for agents or humans.
user-invocable: true
---
...
3. **Decide** — Choose the smallest valid path for `triage`. Name assumptions, blockers, and what is explicitly out of scope before side effects.
4. **Execute** — Classify vault artifacts, assign stage/category, and create actionable next movement.
...
Guardrail: Triage changes metadata/state; it does not redesign the artifact.
