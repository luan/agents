...
When exploring the codebase, search/read relevant blueprints vault domain and decision artifacts so test names and interface vocabulary match the project's language and respect recorded decisions. If no relevant vault docs exist, proceed silently.
