---
name: spec
description: 'Create a PRD-style vault spec that captures what to build, why, user stories, decisions, and non-goals. Use when a product idea needs specification before planning or implementation.'
