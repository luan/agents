---
name: visual-doc
description: Create concise Plannotator-ready HTML companions for vault specs, ticket maps, implementation evidence, reviews, and manual verification gates.
user-invocable: true
---
...
Plannotator. The durable vault spec, ticket, decision, review artifact, or code
remains the source of truth; the visual doc makes decisions and evidence fast to review.
...
3. Use [USE-CASES.md](USE-CASES.md) for spec, ticket, and implementation layouts.
...
- Header: artifact purpose, source vault artifact or code change, review question.
