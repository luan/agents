...
**Single context (most repos):** One `CONTEXT.md` at the project's vault root.

**Multiple contexts:** A `CONTEXT-MAP.md` at the project's vault root lists the contexts, where they live, and how they relate to each other:
