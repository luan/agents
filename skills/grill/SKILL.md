---
name: grill
description: "Ground product or engineering intent before planning by interviewing against repository code and vault context. Use when a feature request, workflow change, or ambiguous implementation idea needs scope, tradeoffs, acceptance criteria, or non-goals clarified before brief/issues/implementation."
argument-hint: "[topic]"
user-invocable: true
---
...
3. **Stop with a Grill Summary**
   ...
   - Suggested `$brief` seed when enough intent is settled.

## Guardrails

- No Plannotator gates in this skill.
- No task creation.
