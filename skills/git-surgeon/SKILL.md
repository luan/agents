---
name: git-surgeon
description: 'Perform hunk-level git operations such as staging, unstaging, discarding, fixups, and commit splitting. Use when the user asks for precise selective git history or working-tree edits.'
---
