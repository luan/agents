...
- The **environment** is a source of truth too. A document that restates it is a
  **cache**. Cache common, stable facts when lookup interrupts the workflow.
  Defer rare or volatile facts to the environment. Remove caches that drift.
